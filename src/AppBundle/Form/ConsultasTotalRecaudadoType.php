...
class ConsultasTotalRecaudadoType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $builder->add('Municipio',EntityType::class,array(
          "label"=>"Municipio:",
          "required"=>false,
        ...
        ))->add('sedeAgencias',EntityType::class,array(
          "label"=>"Sede Agencias:",
          "required"=>false,
          "attr"=>array("class"=>"select2 form-control","placeholder"=>"Seleccione"),
          ...
          'choice_label' => function ($obj) {
            return $obj->getIdSedeAgencia() . ' | ' . $obj->getIdEmpresa();
          },
          "query_builder"=>function(EntityRepository $er){
              $session = new Session();
              $rol = $session->get("rol");
    ...
    {
        return 'appbundle_consultatotalreaudado';
    }
